	<?php 	
	$body_class 	= "dependencia";
	$title 			= "Contrataciones de la Secretaría de Finanzas de la CDMX";
	$description 	= "Contratos de SEFIN";
	$og_image		= "img/og/sefin-contrataciones-abiertas-cdmx.png";
	$canonical		= $url;
