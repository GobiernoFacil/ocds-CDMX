	<?php 	
	$body_class 	= "glosario";
	$title 			= "Glosario de las Contrataciones Abiertas de la Ciudad de México";
	$description 	= "Glosario de términos del estándar de datos para las contrataciones públicas de la CDMX";
	$og_image		= "img/og/glosario.png";
	$canonical		= $url;
...
<h2>Archivos .json</h2>
<p>Formato para el intercambios de datos, que describen los datos con una sintaxis dedicada que se usa para identificar y gestionar los datos. JSON nació como una alternativa a XML, una de las mayores ventajas es que puede ser leído por cualquier lenguaje de programación.
